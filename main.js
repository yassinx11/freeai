        ...
        const yt = class {
          ...
          , bt = class {
            ...
            chat = async (...e) => {
                ...
                !t.model || t.model.startsWith("gpt-") ? i = "openai-completion" : t.model.startsWith("claude-") ? i = "claude" : "meta-llama/Meta-Llama-3.1-8B-Instruct-Turbo" === t.model || "meta-llama/Meta-Llama-3.1-70B-Instruct-Turbo" === t.model || "meta-llama/Meta-Llama-3.1-405B-Instruct-Turbo" === t.model || "google/gemma-2-27b-it" === t.model ? i = "together-ai" : t.model.startsWith("mistral-") || t.model.startsWith("codestral-") || t.model.startsWith("pixtral-") || t.model.startsWith("magistral-") || t.model.startsWith("devstral-") || t.model.startsWith("mistral-ocr-") || t.model.startsWith("open-mistral-") ? i = "mistral" : ["distil-whisper-large-v3-en", "gemma2-9b-it", "gemma-7b-it", "llama-3.1-70b-versatile", "llama-3.1-8b-instant", "llama3-70b-8192", "llama3-8b-8192", "llama3-groq-70b-8192-tool-use-preview", "llama3-groq-8b-8192-tool-use-preview", "llama-guard-3-8b", "mixtral-8x7b-32768", "whisper-large-v3"].includes(t.model) ? i = "groq" : "grok-beta" === t.model ? i = "xai" : t.model.startsWith("grok-") ? i = "openrouter" : "deepseek-chat" === t.model || "deepseek-reasoner" === t.model ? i = "deepseek" : "gemini-1.5-flash" === t.model || "gemini-2.0-flash" === t.model ? i = "gemini" : t.model.startsWith("openrouter:") && (i = "openrouter"),
          ...
          , wt = class {
            ...
            signIn = () => new Promise(( (e, t) => {
                ...
                const r = window.open(puter.defaultGUIOrigin + "/action/sign-in?embedded_in_popup=true&msg_id=" + s + (window.crossOriginIsolated ? "&cross_origin_isolated=true" : ""), "Puter", "toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=600, height=600, top=" + i + ", left=" + n)
                  , o = setInterval(( () => {
                    r.closed && (clearInterval(o),
                ...
                function a(n) {
                    n.data.msg_id == s && (clearInterval(o),
